      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_.85fr] gap-6 md:gap-8 mb-16 md:mb-20 lg:mb-32">
          ...
          <ScrollReveal width="100%" delay={0.1}>
            <HolographicCard className="p-6 sm:p-8 md:p-12 relative overflow-hidden flex flex-col justify-center min-h-[450px] md:min-h-[500px] border-slate-200 bg-white/50">
              ...
              <div className="flex flex-wrap gap-2 md:gap-3 mb-10 md:mb-12">
                {["Early access", "Direct roadmap input", "Fast founder access"].map((benefit) => (
                  <span key={benefit} className="px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-slate-50 border border-slate-200 text-slate-600 text-[13px] md:text-sm font-medium">
                    {benefit}
                  </span>
                ))}
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 mb-10">
                <MagneticButton className="w-full sm:w-auto h-12 px-8 text-base shadow-lg shadow-indigo-500/20">
          ...
          <div className="flex flex-col gap-6 md:gap-8">
            <ScrollReveal width="100%" delay={0.2}>
              <HolographicCard className="p-6 md:p-8 group border-slate-200 bg-white/50">
                <h3 className="text-indigo-600 text-[10px] md:text-xs uppercase tracking-widest mb-3 md:mb-4 font-bold">Now inviting</h3>
                <p className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-3 md:mb-4 text-slate-900">5 PMF Partners</p>
                <p className="text-slate-600 leading-relaxed text-sm md:text-base">
                  An elite cohort of AI teams to help shape the next stage of our quality intelligence platform.
                </p>
                <div className="mt-6 md:mt-8 flex items-center text-indigo-600 font-semibold text-sm group-hover:gap-2 transition-all cursor-pointer">
            ...
            <ScrollReveal width="100%" delay={0.3}>
              <HolographicCard className="p-6 md:p-8 border-slate-200 bg-white/50">
                <h3 className="text-indigo-600 text-[10px] md:text-xs uppercase tracking-widest mb-3 md:mb-4 font-bold">Ideal Cohort</h3>
          ...
          <HolographicCard className="p-6 sm:p-10 md:p-16 relative overflow-hidden border-slate-200 bg-white/50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-10 lg:gap-12">
              <div className="space-y-4 md:space-y-6 text-slate-600 text-base md:text-lg lg:text-xl leading-relaxed">
                <p>Hi — I’m building <strong className="text-indigo-600 font-semibold italic">SupaEval</strong>.</p>
                ...
                <p className="text-pretty">Our mission is simple: <strong className="text-indigo-600 font-semibold underline decoration-indigo-400 underline-offset-8 decoration-2">make every AI agent work with 90%+ quality.</strong></p>
                ...
                <div className="pt-4 md:pt-6 text-slate-900 font-bold text-xl">— Founder, SupaEval</div>
              </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="p-4 md:p-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-indigo-200 transition-colors">
                    <div className="text-indigo-600 text-[10px] md:text-xs uppercase tracking-widest mb-1.5 md:mb-2 font-bold">{item.label}</div>
                    <div className="text-lg md:text-xl font-bold text-slate-900">{item.value}</div>
                  </div>
                ))}
                
                <div className="pt-4">
                  <MagneticButton className="w-full h-12 md:h-14 text-base md:text-lg font-bold">
        ...
        <ScrollReveal width="100%" delay={0.5}>
          <div className="mt-16 md:mt-20 py-8 border-t border-slate-100 text-center text-slate-500 text-xs md:text-sm">
            ...
            <p className="mt-2 flex flex-wrap items-center justify-center gap-1.5">
              Questions? Reach out at <Mail className="h-4 w-4 inline" /> <a href="mailto:imran@supaeval.com" className="text-indigo-600 font-medium hover:underline">imran@supaeval.com</a>
            </p>
          </div>
        </ScrollReveal>
      </div>
