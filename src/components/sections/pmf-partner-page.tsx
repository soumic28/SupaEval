        ...
        <ScrollReveal width="100%">
          <div className="flex justify-center mb-8 md:mb-12">
            <motion.div 
              ...
              className="inline-flex items-center gap-3 px-4 py-2 border border-slate-200 rounded-full bg-white/80 backdrop-blur-md text-sm text-slate-600 shadow-lg shadow-indigo-500/5 group"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_.85fr] gap-6 md:gap-8 mb-16 md:mb-20 lg:mb-32">
          ...
          <ScrollReveal width="100%" delay={0.1}>
            <HolographicCard className="p-6 sm:p-8 md:p-12 relative overflow-hidden flex flex-col justify-center min-h-[450px] md:min-h-[500px] border-slate-200 bg-white/50">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight mb-6 leading-[1.1] text-slate-900">
                ...
                work with <span className="relative">
                  <span className="text-indigo-600">90%+ quality</span>
                  <motion.span 
                    initial={{ width: 0 }}
              ...
              <div className="flex flex-wrap gap-2 md:gap-3 mb-10 md:mb-12">
                {[
                  ...
                  <motion.span 
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-slate-50 border border-slate-200 text-slate-600 text-[13px] md:text-sm font-medium hover:border-indigo-200 hover:text-indigo-600 transition-all cursor-default"
                  >
              ...
              <div className="relative group">
                <motion.div 
                  ...
                  className="flex items-center gap-3 p-3 rounded-2xl bg-white border border-slate-200 w-fit shadow-md shadow-slate-200/50"
                >
          ...
          <div className="flex flex-col gap-6 md:gap-8">
            <ScrollReveal width="100%" delay={0.2}>
              <HolographicCard className="p-6 md:p-8 group border-slate-200 bg-white/50 hover:bg-white transition-colors duration-500">
          ...
          <HolographicCard className="p-6 sm:p-10 md:p-16 relative overflow-hidden border-slate-200 bg-white/50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-10 lg:gap-12">
              <div className="space-y-4 md:space-y-6 text-slate-600 text-base md:text-lg lg:text-xl leading-relaxed">
                ...
                <p className="text-pretty">Our mission is simple: <strong className="relative inline-block">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <motion.div 
                    ...
                    className="p-4 md:p-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-indigo-200 transition-all cursor-default group"
                  >
                ...
                <div className="pt-4">
                  <MagneticButton className="w-full h-12 md:h-14 text-base md:text-lg font-bold shadow-xl shadow-indigo-500/10">
        ...
        <ScrollReveal width="100%" delay={0.5}>
          <div className="mt-16 md:mt-20 py-8 border-t border-slate-100 text-center text-slate-500 text-xs md:text-sm">
            ...
            <p className="mt-3 flex flex-wrap items-center justify-center gap-1.5">
              Questions? Reach out at <Mail className="h-4 w-4 inline text-indigo-400" /> <a href="mailto:imran@supaeval.com" className="text-indigo-600 font-bold hover:underline underline-offset-4 tracking-tight">imran@supaeval.com</a>
            </p>
          </div>
        </ScrollReveal>
      </div>
